...
Your hook should implement a method ``postProcessQUICK_NAVIGATION()`` of the
form
...
data
   A reference to an array with the various links, may thus be changed within
   your hook. Available keys:
